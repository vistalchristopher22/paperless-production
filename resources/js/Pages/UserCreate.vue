...
const submitUser = () => {
  ...
  createUser(user.value)
    .then(() => {
      ...
      new Notyf().success("User has been created successfully");
    })
    .catch((error) => {
  ...
  <layout>
    <div>
      <div class="card">
        ...
        >
          <h6 class="card-title py-2 text-white h6 fw-medium">Create New User</h6>
        </div>
        <div class="card-body">
          <form method="POST" @submit.prevent="submitUser">
            ...
            <div class="d-flex justify-content-between align-items-center mt-4">
              ...
              <div>
                <button
                  type="submit"
                  class="btn btn-dark shadow shadow-lg float-end mt-3"
                  :disabled="isLoading"
                >
