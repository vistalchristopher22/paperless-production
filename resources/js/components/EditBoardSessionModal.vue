...
<template>
  ...
  <div>
    <div
      class="modal fade"
      id="editBoardSessionModal"
      tabindex="-1"
      aria-labelledby="editBoardSessionModalTitle"
      aria-hidden="true"
    >
          ...
          <div class="modal-body">
            ...
            >
              ...
              <div class="float-end">
                <button
                  type="submit"
                  class="btn btn-success letter-spacing-1 text-uppercase"
                >
