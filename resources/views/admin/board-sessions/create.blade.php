...
@section('content')
    ...
    @endif
    <form action="{{ route('board-sessions.store') }}" id="orderBusinessForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('announcement_content') is-invalid @enderror" id="announcement_content"
                            rows="8" name="announcement_content" rows="3">{{ old('announcement_content') }}</textarea>
