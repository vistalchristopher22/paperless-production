...
<body class="">
            ...
            <div class="d-flex justify-content-between align-items-center flex-grow-1 navbar-actions">
                ...
                <div class="d-flex align-items-center">
                    <div class="d-none d-sm-flex dropdown mx-1">
                        <button id="notificationsDropdown" class="btn-action text-muted" type="button"
                                        ...
                                        <div class="simplebar-mask">
                                            <div class="simplebar-offset" style="right: 0px; bottom: 0px;">
                                                <div class="simplebar-content-wrapper"
                                                    ...
                                                    <div id="notification-content" class="simplebar-content"
                                                        style="padding: 0px;">
                    ...
                    <div class="dropdown ms-1">
                        <button id="profileDropdown" class="btn btn-link p-0 position-relative" type="button"
    ...
    <p class="text-muted mb-4">@yield('page-description', 'Default Page description')</p> --}}
            ...
            <div id="offcanvasExample" class="offcanvas offcanvas-end" tabindex="-1"
                aria-labelledby="offcanvasExampleLabel">
                <div class="offcanvas-header">
                    <h5 id="offcanvasExampleLabel" class="offcanvas-title">Offcanvas</h5>
            ...
            <div id="offcanvasSubmittedAgenda" class="offcanvas offcanvas-end" tabindex="-1"
                ...
                <div class="offcanvas-header position-relative">
                    <div class="d-flex flex-row w-100 justify-content-between align-items-center">
                        <h6 id="offcanvasSubmittedAgendaLabel"
                            class="offcanvas-title text-uppercase text-dark fw-bold">
                            Approved Agenda</h6>
                ...
                <div class="pb-6">
                    ...
                    <ul class="list-unstyled mb-6">
                        ...
                        <li class="menu-item"><a class="d-flex align-items-center collapsed" href="#"
                            ...
                            <div id="collapseMaintenance" class="collapse">
                                <ul class="submenu">
                                    @feature('user')
                        ...
                        @feature('administrator')
                            ...
                            <li class="menu-item"><a class="d-flex align-items-center collapsed" href="#"
                                ...
                                <div id="collapseMenuItemUsers" class="collapse">
                                    <ul class="submenu">
                            ...
                            <li class="menu-item"><a class="d-flex align-items-center collapsed" href="#"
                                ...
                                <div id="collapseMenuArchieves" class="collapse">
                                    <ul class="submenu">
